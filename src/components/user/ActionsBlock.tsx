...
export const ActionsBlock = (props: IActionsBlock) => {
  ...
  // QUERIES
  useQuery<IApiResponse<boolean>>([QUERY_KEYS.GET_PRE_UPGRADE],
    getPreUpgrade,
    {
      onSuccess: (res) => {
    ...
    <div className="mt-5 flex justify-end gap-3">
      {
        showUpgrade && (
          <div>
            <button
              className="w-fit border border-black hover:bg-gray-100 font-medium rounded-lg text-lg px-5 py-2.5 text-center"
      ...
      <Link
        ...
        className="w-fit border border-black bg-yellow-300 hover:bg-yellow-400 font-medium rounded-lg text-lg px-5 py-2.5 text-center"
      >Đổi mật khẩu</Link>
