...
export const ImageSearch = (props: IImageSearch) => {
  ...
  // MUTATIONS
  const predictMutation = useMutation<IPredictResponse, FormData>(predict, {
    onSuccess: (res) => {
      const data = res.data;
      filterForm.setValue('breed', [data.breed]);
      filterForm.setValue('species', [
        data.animalType === 'Dog' ? PET_SPECIES.DOG : PET_SPECIES.CAT,
      ]);
      setShowInput(false);
    },
  });
        ...
        <div className="flex flex-col items-center justify-center w-full p-5 mb-5 bg-gray-50 rounded-lg">
          ...
          >
            <div className="flex flex-col items-center justify-center p-14">
              ...
              <p className="my-2 text-sm text-gray-500 font-bold">
